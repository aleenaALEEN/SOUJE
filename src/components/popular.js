  ...
  return (
    <>
       <div className='container-fluid h-[auto]'>
        <Head data={{head:<h1 className='text-[30px] font-bold '>{Heading.h9}</h1>}}/>
        <div className='grid grid-cols-1 gap-y-5 grid-rows-1 bg-white border-t-4 border-black p-[30px] md:p-[3px] xl:p-[30px] flex flex-wrap  justify-center'>
            ...
            <div className=' flex items-center justify-between'>
                ...
                <Para data={{para:<p className='text-[9px] sm:text-[12px] md:text-[9px] lg:text-[12px] hover:text-pink-300 duration-1000 cursor-pointer'>{Paragraph.p8}</p>}}/>
            </div>
            <div className='w-[100%] flex items-center justify-between'>
                 <img className='h-[65px]  w-[80px] sm:w-[105px]' style={{backgroundSize:"100% 100%"}} src={img3}></img>
                <Para data={{para:<p className='text-[9px] sm:text-[12px] md:text-[9px] lg:text-[12px] hover:text-pink-300 duration-1000 cursor-pointer'>{Paragraph.p9}</p>}}/>
            </div>
            <div className='w-[90%] flex items-center justify-between'>
                 <img className='h-[65px]  w-[80px] sm:w-[105px]' style={{backgroundSize:"100% 100%"}} src={img4}></img>
                <Para data={{para:<p className='text-[9px] sm:text-[12px] md:text-[9px] lg:text-[12px] hover:text-pink-300 duration-1000 cursor-pointer'>{Paragraph.p10}</p>}}/>
            </div>
